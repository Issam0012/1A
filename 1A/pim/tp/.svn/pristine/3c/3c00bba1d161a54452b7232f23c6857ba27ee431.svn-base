...
procedure Exemples_Memoire_Dynamique is
	...
	begin
		...
		-- XXX Que se passe-t-il si on exécute le programme avec valkyrie ? all leaks are freed
		--
		...
		-- n'y a plus aucune référence

    end Illustrer_Memoire_Dynamique_Erreur;
    pragma Unreferenced (Illustrer_Memoire_Dynamique_Erreur);
    ...
    pragma Unreferenced (Illustrer_Pile_Locale);
