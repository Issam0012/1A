...
begin
    ...
    --Afficher_Deux_Positions (2); --n'est pas définie ce qui est définie est Afficher_Deux_Positions
    New_Line;
    ...
    --Une_Date.jour := 15; --faux appel
    --Une_Date.Mois := Mois_Suivant;  --faux appel
    Afficher (Une_Date);
    New_Line;
