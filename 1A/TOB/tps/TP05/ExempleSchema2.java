...
public class ExempleSchema2 {
	...
	public static void main(String[] args)
	{
		...
		PointNomme p1 = new PointNomme(3, 2, "A");  //On nomme le point A
		PointNomme p2 = new PointNomme(6, 9, "S");  //On nomme le point S
		...
		PointNomme barycentre = new PointNomme(sx / 3, sy / 3, "C");  //On nomme le barycentre
