...
methode_finite_diff = 2; % 1: avant, 2: centrée, 3: complexe
...
disp( strcat('Methode diff finies = ' +  string(list_diff_finies(methode_finite_diff))) ) ;
...
if True_Jacobienne
	...
	switch methode_finite_diff
	  ...
	  case 3 
	     Jres = diff_finies_complexe(@res1,beta0, ndigits);
...
for i=1:2
  ...
  switch methode_finite_diff
	  ...
	  case 3 
	     [beta, norm_gradf_beta, f_beta, res, norms, k, exitflag] = GN_ref(@res1, @(beta) diff_finies_complexe(@res1,beta,ndigits), beta0, option); 
