function [W, V, flag] = eigen_2021_modified(imat, n, v, m, eps, maxit, percentage, p, genere)
...
switch v
    ...
    case 12
        fprintf('\n******* calcul avec la méthode de la puissance itérée modifié ******\n');
        t_v =  cputime;
        % WA valeurs propres
        % VA vecteurs propres
        ...
        if(flagB == 0)
            ...
            fprintf('\nTemps puissance itérée modifiée = %0.3e\n',t_v);            
            fprintf('Nombre de valeurs propres pour attendre le pourcentage = %d\n', n_evB);
            fprintf('Nombre d''itérations pour chaque couple propre\n');
            for i=1:n_evB
                fprintf('couple %d : %d\n', i, itvB(i));
