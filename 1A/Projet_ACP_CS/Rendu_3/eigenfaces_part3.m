...
% Calcul des vecteurs/valeurs propres de la matrice Sigma2 :
[Val2M, Vect2M] = subspace_iter_v3(Sigma2M, m, percentage, p, eps, maxit);
...
save('eigenfaces_part3.mat', 'individu_moyen', 'W','X', 'X_centre', 'nb_personnes', 'nb_postures', 'nb_personnes_base', 'nb_postures_base', ...
    'liste_personnes_base','liste_base','liste_personnes', 'X_masque','liste_postures', 'L', 'H', 'ligne_max','ligne_min', 'colonne_max', 'colonne_min')
