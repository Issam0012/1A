...
(*L'utilisation inconvenable d'un break ou d'un continue*)
exception MauvaiseUtilisationBreak
exception MauvaiseUtilisationContinue

(* L'appel à Break ou continue avec un nom de loop invalide*)
exception NomLoopInvalide of string