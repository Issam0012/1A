...
| IF exp=e li=bloc                  {ConditionnelleOptionnel (exp,li)}
| WHILE exp=e li=bloc               {TantQue (exp,li)}
| RETURN exp=e PV                   {Retour (exp)}
| LOOP li=bloc                      {Loop (li)}
| m=ID DP LOOP li=bloc              {LoopNom (m,li)}
| BREAK PV                          {Break}
| BREAK n=ID PV                     {BreakNom(n)}
| CONTINUE PV                       {Continue}
| CONTINUE n=ID PV                  {ContinueNom(n)}
// | a=aff EQUAL e=e                   {AffectationPointeur (a,e)}
