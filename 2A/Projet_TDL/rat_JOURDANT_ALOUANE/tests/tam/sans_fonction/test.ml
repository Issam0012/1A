...
let%expect_test "testLoopBreak" =
  runtam (pathFichiersRat^"testLoopBreak.rat");
  [%expect{| 10 |}]
  
let%expect_test "testLoopContinue" =
  runtam (pathFichiersRat^"testLoopContinue.rat");
  [%expect{| 1266645 |}]

let%expect_test "testLoopImbrique" =
  runtam (pathFichiersRat^"testLoopImbrique.rat");
  [%expect{| 240 |}]

let%expect_test "testLoopNonMasquage" =
  runtam (pathFichiersRat^"testLoopNonMasquage.rat");
  [%expect{| 01234567891011121314151617181920212223240123456789101112131415161718192021222324 |}]

let%expect_test "testLoopNom" =
  runtam (pathFichiersRat^"testLoopNom.rat");
  [%expect{| 10 |}]

let%expect_test "testLoopWarning" =
  runtam (pathFichiersRat^"testLoopWarning.rat");
  [%expect{| 
  WARNING ! Il existe 2 loop imbriquées avec le même nom 
  1010 |}]
