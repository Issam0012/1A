...
(* Nombres entiers : A COMPLETER *)
  | (['0'-'9'] | (['1' - '9'] (chiffre '_')* chiffre)) as texte   { (ENTIER (int_of_string texte)) }
  | (['0'-'9' 'A'-'F' 'a'-'f'] | (['1'-'9' 'A'-'F' 'a'-'f'] (['0'-'9' 'A'-'F' 'a'-'f' '_'])* ['0'-'9' 'A'-'F' 'a'-'f'])) as texte   { (ENTIER (int_of_string texte)) }
  | (['0'-'9'] | (['1' - '7'] (['0'-'7' '_'])* ['0'-'7'])) as texte   { (ENTIER (int_of_string texte)) }
  | (['0'-'1'] | ('1' (['0'-'1' '_'])* ['0'-'1'])) as texte   { (ENTIER (int_of_string texte)) }
